...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{My Study Algorithm and problems Gem Plan.}
  spec.description   = %q{I just created this gem to algorithm and problems for the ruby gems world, okay.}
